...
# Extract optional AI configuration from .env if the user wants a custom model
AI_MODEL=$(grep "^AI_MODEL=" supabase/docker/.env | cut -d '=' -f2)
AI_MODEL=${AI_MODEL:-"gpt-4o"}

AI_ENDPOINT=$(grep "^AI_ENDPOINT=" supabase/docker/.env | cut -d '=' -f2)
