...
export default function CodeStudio({ initialCode, onClose, onSave, isStandalone }) {
    ...
    return (
        <div className="animate-fade-in" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(5, 5, 10, 0.85)', backdropFilter: 'blur(12px)', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px' }}>
            ...
            <div className="glass-panel" style={{ width: '100%', maxWidth: '1500px', height: '100%', minHeight: 0, background: 'rgba(11, 12, 16, 0.7)', border: '1px solid rgba(255,255,255,0.1)', padding: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.1)', borderRadius: '16px' }}>
