...
export default function BlackHoleIcon({ size = 24, className = "", style = {} }) {
  return (
    ...
    >
      ...
      {/* Back halves of the accretion disk rings (drawn behind black hole) */}
      ...
      {/* Front halves of the accretion disk rings (drawn in front of black hole) */}
      ...
      {/* Gravitational lensing rings (top and bottom) */}
      <path d="M 8 7.5 A 4 4 0 0 1 16 7.5" stroke="url(#blackhole-grad)" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.9" />
      <path d="M 9.5 5.5 A 2.5 2.5 0 0 1 14.5 5.5" stroke="url(#blackhole-grad)" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.5" />
      
      <path d="M 8 16.5 A 4 4 0 0 0 16 16.5" stroke="url(#blackhole-grad)" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.9" />
      <path d="M 9.5 18.5 A 2.5 2.5 0 0 0 14.5 18.5" stroke="url(#blackhole-grad)" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.5" />
    </svg>
  );
}
