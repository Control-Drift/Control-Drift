             ...
             <Router>
               ...
               <aside className={`sidebar ${isMobileMenuOpen ? 'mobile-open' : ''} ${effectiveIsSidebarCollapsed ? 'collapsed' : ''}`}>
                 <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', position: 'relative' }}>
                   <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '0', overflow: 'hidden', width: '100%', justifyContent: effectiveIsSidebarCollapsed ? 'center' : 'flex-start', paddingLeft: effectiveIsSidebarCollapsed ? '0' : '8px' }}>
